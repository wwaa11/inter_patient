...
@section('content')
    <div class="min-h-screen bg-slate-50 py-8 dark:bg-slate-900">
        <div class="mx-auto w-full px-4 sm:px-6 lg:px-8">
            ...
            {{-- Search & Filter --}}
            <form action="{{ route('preauth.index') }}" method="GET"
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('preauth.index') }}"
                        class="inline-flex items-center rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-700 shadow-sm hover:bg-slate-50 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-300 dark:hover:bg-slate-600">
                        Reset
                    </a>
                </div>
            </form>
                            ...
                            @forelse($preAuthorizations as $pa)
                                <tr class="hover:bg-slate-50 dark:hover:bg-slate-700">
                                    ...
                                    <td class="whitespace-nowrap px-6 py-4">
                                        ...
                                        @endphp
                                        <span
                                            class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium {{ $statusClass }}">{{ $pa->case_status }}</span>
                                    </td>
                                ...
                                <tr>
                                    <td class="px-6 py-12 text-center" colspan="7">
                                        <div class="text-center text-slate-500 dark:text-slate-400">
                                            ...
                                            <p class="mt-1">Create your first pre-authorization case or adjust filters.
                                            </p>
                                        </div>
                                    </td>
                                </tr>
