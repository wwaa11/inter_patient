        ...
        <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-slate-900 dark:text-white">Add Service Type</h1>
                        <p class="mt-2 text-slate-600 dark:text-slate-400">Create a new service type</p>
                    </div>
                </div>
            </div>
