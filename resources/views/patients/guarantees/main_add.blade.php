                ...
                <div class="mb-6 rounded-lg bg-white shadow-sm dark:bg-slate-800 dark:text-slate-300">
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 px-6 pb-4 md:grid-cols-3">
                            <!-- Embassy Selection -->
                            <div>
                                <label class="mb-2 block text-sm font-semibold text-gray-700 dark:text-slate-300" for="embassy">
                                ...
                                <select class="@error("embassy") border-red-500 @enderror w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100" id="embassy" name="embassy" required>
                                    ...
                                    @foreach ($embassies as $embassy)
                                        <option class="dark:bg-slate-800 dark:text-slate-300" value="{{ $embassy->name }}" {{ old("embassy") == $embassy->name ? "selected" : "" }}>{{ $embassy->name }}</option>
                                    @endforeach
                                </select>
                                @error("embassy")
                    ...
                    <div class="rounded-lg bg-white shadow-sm dark:bg-slate-800">
                        ...
                        <div class="space-y-6 p-6">
                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    <div class="relative">
                                        <input class="w-full rounded-lg border border-gray-300 px-4 py-2 pl-10 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100" id="caseSearch" type="text" placeholder="Search guarantee cases...">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="max-h-40 overflow-y-auto rounded-lg border border-gray-200 dark:border-slate-700" id="availableCases">
                                        @foreach ($guaranteeCases as $case)
                                            <div class="case-item flex items-center justify-between border-b border-gray-100 p-3 last:border-b-0 hover:bg-gray-50 dark:border-slate-700 dark:hover:bg-slate-600" data-case-name="{{ strtolower($case->name) }}">
