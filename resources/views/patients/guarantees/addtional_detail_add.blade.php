        ...
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="flex items-center">
                            ...
                            <div>
                                <h1 class="flex items-center text-2xl font-bold text-gray-900 dark:text-slate-100">
                                    ...
                                    Add Additional Guarantee Details
                                </h1>
            ...
            <form class="" action="{{ route("patients.guarantees.additional.detail.store", [$patient->hn, $guarantee->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6 rounded-lg bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800">
                    <div class="space-y-6">
                        <div class="border-b border-gray-200 px-6 py-4 dark:border-slate-700">
                            <h2 class="text-lg font-semibold text-gray-900 dark:text-slate-100">Guarantee Information</h2>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 px-6 pb-4 md:grid-cols-3">
                            ...
                            <div>
                                ...
                                <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100" id="embassy_ref" type="text" name="embassy_ref" required placeholder="Enter embassy reference" readonly value=" {{ $guarantee->additionalType->name }}">
                            </div>
                            ...
                            <div>
                                ...
                                <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100" id="embassy_ref" readonly type="text" name="embassy_ref" required placeholder="Enter embassy reference" value="{{ old("embassy_ref") ?? $guarantee->embassy_ref }}">
                            ...
                            <div>
                                ...
                                <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100" id="mb" readonly type="text" name="mb" placeholder="Enter MB" value="{{ old("mb") ?? $guarantee->mb }}">
                            </div>
                            ...
                            <div>
                                ...
                                <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100" id="issue_date" readonly type="date" name="issue_date" required value="{{ old("issue_date") ?? ($guarantee->issue_date ? \Carbon\Carbon::parse($guarantee->issue_date)->format("Y-m-d") : "") }}">
                            </div>
                            ...
                            <div>
                                ...
                                <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100" id="cover_start_date" readonly type="date" name="cover_start_date" value="{{ old("cover_start_date") ?? ($guarantee->cover_start_date ? \Carbon\Carbon::parse($guarantee->cover_start_date)->format("Y-m-d") : "") }}">
                            </div>
                            ...
                            <div>
                                ...
                                <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100" id="cover_end_date" readonly type="date" name="cover_end_date" value="{{ old("cover_end_date") ?? ($guarantee->cover_end_date ? \Carbon\Carbon::parse($guarantee->cover_end_date)->format("Y-m-d") : "") }}">
                            ...
                            <div>
                                ...
                                <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100" id="total_price" readonly type="text" name="total_price" placeholder="Enter Total Price" value="{{ old("total_price") ?? $guarantee->total_price }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-end space-x-3 border-t border-gray-200 pt-6 dark:border-slate-700">
                    ...
                    <button class="rounded-lg bg-blue-500 px-6 py-3 text-white transition-colors hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-700" type="submit">
