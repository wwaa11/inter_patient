    ...
    <div class="min-h-screen bg-gray-50 py-6 dark:bg-slate-900">
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="border-b border-gray-200 px-6 py-4 dark:border-slate-700">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <a class="mr-4 text-gray-500 hover:text-gray-700 dark:text-slate-300" href="{{ route("patients.view", $patient->hn) }}">
                                <i class="fas fa-arrow-left text-lg"></i>
                            </a>
                            <div>
                                <h1 class="flex items-center text-2xl font-bold text-gray-900 dark:text-slate-300">
            ...
            <form class="" action="{{ route("patients.guarantees.additional.store", $patient->hn) }}" method="POST" enctype="multipart/form-data">
                @csrf
                {{-- Information Content --}}
                <div class="mb-6 rounded-lg bg-white shadow-sm dark:bg-slate-800 dark:text-slate-300">
                    <div class="space-y-6">
                        <div class="border-b border-gray-200 px-6 py-4 dark:border-slate-700">
                            <h2 class="text-lg font-semibold text-gray-900 dark:text-slate-300">Guarantee Information</h2>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-6 px-6 pb-4 md:grid-cols-3">
                            ...
                            <div>
                                ...
                                <select class="@error("type") border-red-500 @enderror w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100" id="type" name="type" required>
                                    @foreach ($additionalTypes as $type)
                                        <option class="dark:bg-slate-800 dark:text-slate-300" {{ old("type") == $type->id ? "selected" : "" }} value="{{ $type->id }}">{{ $type->name }}</option>
                                    @endforeach
                                </select>
                                @error("type")
                            ...
                            <div>
                                ...
                                <input class="@error("embassy_ref") border-red-500 @enderror w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100" id="embassy_ref" type="text" name="embassy_ref" required placeholder="Enter embassy reference" value="{{ old("embassy_ref") }}">
                                @error("embassy_ref")
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input class="@error("mb") border-red-500 @enderror w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100" id="mb" type="text" name="mb" placeholder="Enter MB" value="{{ old("mb") }}">
                                @error("mb")
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    <!-- Left Panel - Form -->
                    <div class="rounded-lg bg-white shadow-sm dark:bg-slate-800 dark:text-slate-300">
                        <div class="border-b border-gray-200 px-6 py-4 dark:border-slate-600">
                            <h2 class="text-lg font-semibold text-gray-900 dark:text-slate-300">Coverage Area / Detail</h2>
                        </div>
                        <div class="space-y-6 p-6">
                            ...
                            <!-- Coverage Area / Detail Section -->
                            <div class="border-t border-gray-200 pt-6 dark:border-slate-600">
                                <div class="mb-4 flex items-center justify-between">
                                    <h3 class="text-md font-semibold text-gray-900 dark:text-slate-300">
                                ...
                                <div class="space-y-6" id="detailEntries">
                                    ...
                                    <div class="detail-entry rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-slate-600 dark:bg-slate-700">
                                        <div class="mb-4 flex items-center justify-between">
                                            <h4 class="text-sm font-semibold text-gray-800 dark:text-slate-300">
                                        ...
                                        <div class="flex flex-col gap-4">
                                            ...
                                            <div>
                                                ...
                                                <div class="relative">
                                                    <input class="@error("details.0.additional_case_name") border-red-500 @enderror w-full rounded-lg border border-gray-300 px-4 py-3 pr-10 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-300" type="text" placeholder="Search and select a case..." onclick="toggleCaseDropdown(this)" oninput="filterCases(this)" readonly value="{{ old("details.0.additional_case_name") }}">
                                                    ...
                                                    <div class="case-dropdown absolute z-10 mt-1 hidden max-h-60 w-full overflow-y-auto rounded-lg border border-gray-300 bg-white shadow-lg dark:border-slate-600 dark:bg-slate-700">
                                                        ...
                                                        <div class="case-options">
                                                            <div class="case-option cursor-pointer px-3 py-2 hover:bg-gray-100 dark:bg-slate-800 dark:hover:bg-slate-600" data-value="" data-name="" onclick="selectCase(this, 0)">
                                                                Please select
                                                            </div>
                                                            @if (isset($additionalCases))
                                                                @foreach ($additionalCases as $case)
                                                                    <div class="case-option cursor-pointer px-3 py-2 hover:bg-gray-100 dark:bg-slate-800 dark:hover:bg-slate-600" data-value="{{ $case->id }}" data-name="{{ $case->name }}" onclick="selectCase(this, 0)">
                                                                        {{ $case->name }}
                                                                    </div>
                                                                @endforeach
                                                            @endif
                                            ...
                                            <div>
                                                ...
                                                <textarea class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-300" name="details[0][detail]" rows="3" required placeholder="Enter detail information...">{{ old("details.0.detail") }}</textarea>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-300" type="text" name="details[0][definition]" placeholder="Enter definition..." value="{{ old("details.0.definition") }}">
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-300" type="text" name="details[0][amount]" placeholder="Enter amount..., Ex. 15 tabs" value="{{ old("details.0.amount") }}">
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-300" type="number" step="0.01" name="details[0][price]" placeholder="Enter price..." value="{{ old("details.0.price") }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>

                                <button class="mt-4 w-full rounded-lg bg-green-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800" type="button" onclick="addDetailEntry()">
                    ...
                    <div class="relative min-h-[800px] rounded-lg bg-white shadow-sm md:col-span-2 dark:bg-slate-800">
                        <div class="border-b border-gray-200 px-6 py-4 dark:border-slate-600">
                            <h2 class="flex items-center text-lg font-semibold text-gray-900 dark:text-slate-300">
                        ...
                        <div class="absolute bottom-0 left-0 right-0 m-auto p-6">
                            <div class="flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-6 dark:border-slate-600 dark:bg-slate-700" id="filePreview">
                                <div class="text-center">
                                    <i class="fas fa-file-upload mb-3 text-4xl text-gray-400 dark:text-slate-300"></i>
                                    <p class="text-gray-500 dark:text-slate-300">No file selected</p>
                                    <p class="mt-1 text-sm text-gray-400 dark:text-slate-300">Upload a file to see preview</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function previewFile(input) {
                ...
                if (file) {
                    ...
                    if (fileType.startsWith('image/')) {
                        ...
                        const reader = new FileReader();
                        reader.onload = function(e) {
                            preview.innerHTML = `<embed class="p-6 h-full min-h-[700px] w-full rounded-lg" src="${e.target.result}" type="application/pdf">`;
                        };
                        reader.readAsDataURL(file);
                    } else {
                        preview.innerHTML = `
            ...
            function addDetailEntry() {
                ...
                newEntry.className = 'detail-entry border border-gray-200 rounded-lg p-4 bg-gray-50 dark:bg-slate-700 dark:border-slate-600';
                newEntry.innerHTML = `
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" class="w-full rounded-lg border border-gray-300 px-4 py-3 pr-10 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:text-slate-300 dark:border-slate-600" placeholder="Search and select a case..." onclick="toggleCaseDropdown(this)" oninput="filterCases(this)" readonly>
                            <i class="fas fa-chevron-down absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 pointer-events-none"></i>
                            <div class="case-dropdown absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto hidden dark:bg-slate-700 dark:text-slate-300 dark:border-slate-600">
                                <div class="p-2 border-b dark:border-slate-600">
                                    <input type="text" class="case-search w-full px-3 py-2 border border-gray-300 rounded text-sm dark:bg-slate-800 dark:text-slate-300 dark:border-slate-600" placeholder="Type to search..." oninput="filterCaseOptions(this)">
                                </div>
                                <div class="case-options dark:bg-slate-800">
                                    <div class="case-option cursor-pointer px-3 py-2 hover:bg-gray-100 dark:hover:bg-slate-600" data-value="" data-name="" onclick="selectCase(this, ${newIndex})">
                                        Please select
                                    </div>
                                    @if (isset($additionalCases))
                                        @foreach ($additionalCases as $case)
                                            <div class="case-option px-3 py-2 hover:bg-gray-100 cursor-pointer dark:hover:bg-slate-600" data-value="{{ $case->id }}" data-name="{{ $case->name }}" onclick="selectCase(this, ${newIndex})">
                                                {{ $case->name }}
                                            </div>
                                        @endforeach
                                    @endif
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center dark:text-slate-300">
                                ...
                                <label for="dateRange_${newIndex}" class="text-sm text-gray-600 dark:text-slate-300">Use date range</label>
                            </div>
                            <div class="date-single">
                                        <div class="space-y-2">
                                            <div class="flex items-center justify-between">
                                            ...
                                            <div class="date-entries dark:text-slate-300" id="dateEntries_${newIndex}">
                                                <div class="date-entry flex items-center space-x-2 mb-2">
                                                    <input class="flex-1 rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:text-slate-300 dark:border-slate-600" type="date" name="details[${newIndex}][specific_dates][]">
                            ...
                            <div class="date-range hidden">
                                <div class="grid grid-cols-2 gap-2">
                                    <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:text-slate-300 dark:border-slate-600" type="date" name="details[${newIndex}][date_start]" placeholder="Start date">
                                    <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:text-slate-300 dark:border-slate-600" type="date" name="details[${newIndex}][date_end]" placeholder="End date">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:text-slate-300 dark:border-slate-600" name="details[${newIndex}][detail]" rows="3" required placeholder="Enter detail information..."></textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:text-slate-300 dark:border-slate-600" type="text" name="details[${newIndex}][definition]" placeholder="Enter definition...">
                    </div>
                    ...
                    <div>
                        ...
                        <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:text-slate-300 dark:border-slate-600" type="text" name="details[${newIndex}][amount]" placeholder="Enter amount..., Ex. 15 tabs">
                    </div>
                    ...
                    <div>
                        ...
                        <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:bg-slate-700 dark:text-slate-300 dark:border-slate-600" type="number" step="0.01" name="details[${newIndex}][price]" placeholder="Enter price...">
                    </div>
                </div>
                `;
            ...
            function addDateEntry(detailIndex) {
                ...
                <input class="flex-1 rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-300" type="date" name="details[${detailIndex}][specific_dates][]">
