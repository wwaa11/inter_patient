...
<div class="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
    <div class="relative py-3 sm:max-w-xl sm:mx-auto w-full max-w-screen-lg">
        ...
        <form action="{{ route('patients.guarantees.additional.store', $patient->hn) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                ...
                <div class="rounded-xl bg-white p-8 shadow-lg">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 @error('embassy') border-red-500 @enderror" id="embassy" name="embassy" required>
                ...
                @enderror
                        ...
                        <div>
                            ...
                            <input class="w-full rounded-lg border-2 border-dashed border-gray-300 px-4 py-3 transition-all file:mr-4 file:rounded-full file:border-0 file:bg-blue-50 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-blue-700 hover:file:bg-blue-100 focus:border-blue-500 @error('file') border-red-500 @enderror" id="file" type="file" name="file[]" multiple accept=".pdf,.jpg,.jpeg,.png">
                            @error('file')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 @error('type') border-red-500 @enderror" id="type" name="type" required>
                ...
                @enderror
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                            <div>
                                ...
                                <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 @error('embassy_ref') border-red-500 @enderror" id="embassy_ref" type="text" name="embassy_ref" placeholder="Enter embassy reference" value="{{ old('embassy_ref') }}">
                                @error('embassy_ref')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 @error('mb') border-red-500 @enderror" id="mb" type="text" name="mb" placeholder="Enter MB" value="{{ old('mb') }}">
                                @error('mb')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                            <div>
                                ...
                                <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 @error('issue_date') border-red-500 @enderror" id="issue_date" type="date" name="issue_date" required value="{{ old('issue_date') }}">
                                @error('issue_date')
                                    <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 @error('cover_start_date') border-red-500 @enderror" id="cover_start_date" type="date" name="cover_start_date" required value="{{ old('cover_start_date') }}">
                            ...
                            <div>
                                ...
                                <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 @error('cover_end_date') border-red-500 @enderror" id="cover_end_date" type="date" name="cover_end_date" required value="{{ old('cover_end_date') }}">
                        ...
                        <div>
                            ...
                            <input class="w-full rounded-lg border border-gray-300 px-4 py-3 transition-all focus:border-transparent focus:ring-2 focus:ring-blue-500 @error('total_price') border-red-500 @enderror" id="total_price" type="number" name="total_price" step="0.01" min="0" required placeholder="Enter total price" value="{{ old('total_price') }}">
                            @error('total_price')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="rounded-xl bg-white p-8 shadow-lg">
                    ...
                    <div id="guarantee-details-container" class="space-y-4">
                        <!-- Initial Detail Row -->
                        <div class="guarantee-detail-row rounded-lg border border-gray-200 p-4">
                            <div class="mb-4 flex items-center justify-between">
                                ...
                                <button type="button" class="remove-detail-btn hidden rounded-full bg-red-500 px-3 py-1 text-sm text-white hover:bg-red-600" onclick="removeDetailRow(this)">
                    ...
                    <button type="button" id="add-detail-btn" class="mt-4 w-full rounded-lg bg-green-500 px-4 py-2 text-white hover:bg-green-600 transition-colors">
            ...
            <div class="flex justify-center space-x-4">
                <a href="{{ route('patients.show', $patient->hn) }}" class="rounded-lg bg-gray-500 px-8 py-3 text-white hover:bg-gray-600 transition-colors">
                    <i class="fas fa-arrow-left mr-2"></i>Cancel
                </a>
                <button type="submit" class="rounded-lg bg-blue-600 px-8 py-3 text-white hover:bg-blue-700 transition-colors">
