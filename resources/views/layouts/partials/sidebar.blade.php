                ...
                <li>
                    <ul class="-mx-2 space-y-1" role="list">
                        ...
                        @if (auth()->user()->isAdmin())
                            ...
                            <!-- User Management -->
                            <li
                                class="border-b border-slate-200 dark:border-slate-700 nav-item group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-slate-700 dark:text-slate-300 cursor-default">
                                Settings
                            </li>
                            <li>
